      ...
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="max-w-6xl mx-auto">
          {steps.map((step, index) => (
            ...
            >
              <div className="flex-shrink-0 w-24 h-24 sm:w-28 sm:h-28 md:w-32 md:h-32 rounded-full bg-gradient-to-br from-[hsl(270,80%,65%)] via-[hsl(260,85%,60%)] to-[hsl(220,90%,60%)] flex items-center justify-center shadow-[0_20px_60px_-15px_hsl(270,80%,65%/0.6)] relative group">
                ...
                <div className="absolute -top-1 -right-1 sm:-top-2 sm:-right-2 md:-top-1 md:-right-1 w-7 h-7 sm:w-8 sm:h-8 md:w-10 md:h-10 bg-white text-[hsl(270,80%,65%)] rounded-full flex items-center justify-center text-xs sm:text-sm md:text-base font-bold">
                  {index + 1}
                </div>
              </div>
              
              <div className="flex-1 bg-white/5 rounded-xl sm:rounded-2xl p-6 sm:p-8 md:p-10 hover:shadow-[0_25px_60px_-15px_hsl(270,80%,65%/0.4)] transition-all duration-500 group">
                ...
                <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-2 sm:mb-4 text-white group-hover:text-[hsl(270,80%,75%)] transition-colors duration-300">
