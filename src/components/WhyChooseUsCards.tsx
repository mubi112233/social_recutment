...
const cards = {
  en: [
    ...
    },
    {
      ...
      description: "We respond to your urgent inquiries within 2 hours, guaranteed.",
    },
    {
      icon: Lock,
  ...
  ge: [
    ...
    },
    {
      ...
      description: "Wir antworten auf Ihre dringenden Anfragen innerhalb von 2 Stunden, garantiert.",
    },
    {
      icon: Lock,
