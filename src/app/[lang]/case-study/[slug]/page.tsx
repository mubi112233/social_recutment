...
export async function generateMetadata({
  ...
  const title = `${caseStudy.company} - ${caseStudy.title} | SocialRecruit`;
  ...
  return {
    ...
    keywords: currentLang === "ge"
      ? ["Fallstudie", "Social-Media-Recruiting Ergebnisse", caseStudy.company, caseStudy.industry, "SocialRecruit"]
      : ["Case Study", "Social Recruitment Results", caseStudy.company, caseStudy.industry, "SocialRecruit"],
...
export default async function CaseStudyPage({
  ...
  const caseStudyJsonLd = {
    ...
    "publisher": { "@type": "Organization", "name": "SocialRecruit", "logo": { "@type": "ImageObject", "url": absoluteUrl("/og-image.jpg") } },
